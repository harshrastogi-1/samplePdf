...
//     fromAsset('assets/files/demo-link.pdf', 'demo.pdf').then((f) {
//       setState(() {
//         pathPDF = f.path;
//       });
//     });
//     fromAsset('assets/files/demo-landscape.pdf', 'landscape.pdf').then((f) {
//       setState(() {
...
// }
import 'package:flutter/material.dart';
import 'package:sample/ui/view/List.dart';
